...
import {getChromeMajorVersion} from '@xyz/electron-versions';
...
function handleHotReload() {
  ...
  return {
    name: '@xyz/preload-process-hot-reload',
    ...
    config(config, env) {
      ...
      const rendererWatchServerProvider = config.plugins.find(p => p.name === '@xyz/renderer-watch-server-provider');
